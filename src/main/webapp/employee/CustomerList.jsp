            ...
            <tbody>
                <c:forEach var="customer" items="${customers}">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/CustomerServlet?action=get&customerTel=${customer.customerTel}" class="btn btn-primary btn-sm">詳情</a>
                            <a href="${pageContext.request.contextPath}/CustomerServlet?action=getForUpdate&customerTel=${customer.customerTel}" class="btn btn-warning btn-sm">修改</a>
