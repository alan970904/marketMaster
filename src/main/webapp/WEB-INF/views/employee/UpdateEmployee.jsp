...
<body>
	...
	<main class="container mt-4">
		...
		<form action="${pageContext.request.contextPath}/employee/update"
			...
			<table class="table table-bordered">
				...
				<tr>
					...
					<td><input type="text" name="employeeTel" id="employeeTel"
						value="${employeeToUpdate.employeeTel}" required></td>
				</tr>
				<tr>
					<th>身分證號碼:</th>
					<td><input type="text" name="employeeIdcard"
						id="employeeIdcard" value="${employeeToUpdate.employeeIdcard}" required></td>
				</tr>
				<tr>
					<th>Email:</th>
					<td><input type="email" name="employeeEmail"
						id="employeeEmail" value="${employeeToUpdate.employeeEmail}" required></td>
				</tr>
				<tr>
					<th>密碼:</th>
					<td><input type="password" name="password" id="password"
						value="${employeeToUpdate.password}" required></td>
				</tr>
				<tr>
					<th>職位編號:</th>
					<td><input type="text" name="positionId" id="positionId"
						value="${employeeToUpdate.positionId}" required></td>
				</tr>
				<tr>
					<th>入職日期:</th>
					<td><input type="date" name="hiredate"
						value="${employeeToUpdate.hiredate}" required></td>
				</tr>
				<tr>
					<th>離職日期:</th>
					<td><input type="date" name="resigndate"
						value="${employeeToUpdate.resigndate}"></td>
				</tr>
			</table>
